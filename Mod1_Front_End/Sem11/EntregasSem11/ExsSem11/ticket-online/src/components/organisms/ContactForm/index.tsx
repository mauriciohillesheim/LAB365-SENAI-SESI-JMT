...
const ContactForm = () => {
  ...
  const onSubmit = (data: ContactFormData) => {
    ...
    alert(`Obrigado pelo contato, ${data.email}! Seus dados foram registrados no console.`);
  };
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="contact-form">
      ...
      <div className="form-group">
        ...
        <input id="email" {...register("email", { required: "O e-mail é obrigatório" })} />
      ...
      <div className="form-group">
        ...
        <input id="assunto" {...register("assunto", { required: "O assunto é obrigatório" })} />
      ...
      <div className="form-group">
        ...
        <textarea id="mensagem" {...register("mensagem", { required: "A mensagem é obrigatória" })} />
        {errors.mensagem && <p className="error-message">{errors.mensagem.message}</p>}
      </div>

      <div className="form-group-checkbox">
         {/* Campo opcional de urgência (booleano) */}
        <input type="checkbox" id="urgencia" {...register("urgencia")} />
        <label htmlFor="urgencia">É urgente?</label>
      </div>
